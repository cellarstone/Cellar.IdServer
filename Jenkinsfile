      ...
      steps {
        parallel (
          idserver: {
            ...
            sh 'docker tag idserver eu.gcr.io/cellarstone-1488228226623/idserver:dev.0.0.11'
            sh 'gcloud docker -- push eu.gcr.io/cellarstone-1488228226623/idserver:dev.0.0.11'
