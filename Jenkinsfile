      ...
      steps {
        parallel(
          "IdServer": {
            ...
            sh 'docker tag idserver eu.gcr.io/cellarstone-1488228226623/idserver:dev.0.0.9'
            sh 'gcloud docker -- push eu.gcr.io/cellarstone-1488228226623/idserver:dev.0.0.9'
      ...
      steps {
        parallel(
          "IdServer": {
            ...
            sh 'docker build -t idserver ./Cellar.IdServer'
            sh 'docker tag idserver eu.gcr.io/cellarstone-1488228226623/idserver:stag.0.0.8'
            sh 'gcloud docker -- push eu.gcr.io/cellarstone-1488228226623/idserver:stag.0.0.8'
      ...
      steps {
        parallel(
          "IdServer": {
            ...
            sh 'docker build -t idserver ./Cellar.IdServer'
            sh 'docker tag idserver eu.gcr.io/cellarstone-1488228226623/idserver:prod.0.0.9'
            sh 'gcloud docker -- push eu.gcr.io/cellarstone-1488228226623/idserver:prod.0.0.9'
