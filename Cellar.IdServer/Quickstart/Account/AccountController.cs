...
namespace Cellar.IdServer.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            await _events.RaiseAsync(new UserLoginSuccessEvent(provider, userId, user.Id.ToString(), user.Email));
            await HttpContext.Authentication.SignInAsync(user.Id.ToString(), user.Email, provider, props, additionalClaims.ToArray());
